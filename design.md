...
* Try-Catch main method and privatize parsing programController mode for increased security.
* For visual in-programController UI: small center box will contain a blinking black arrow pointing towards the current colours turn; the large empty boxes on either side of the beads will contain the adjacent beads score.
